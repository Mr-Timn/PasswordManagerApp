...
#define kyber_shake128_absorb KYBER1024_NAMESPACE(_kyber_shake128_absorb)
void kyber_shake128_absorb(keccak_state *s,
                           const uint8_t seed[KYBER1024_SYMBYTES],
                           uint8_t x,
                           uint8_t y);

#define kyber_shake256_prf KYBER1024_NAMESPACE(_kyber_shake256_prf)
...
#define kdf(OUT, IN, INBYTES) shake256(OUT, KYBER1024_SSBYTES, IN, INBYTES)
